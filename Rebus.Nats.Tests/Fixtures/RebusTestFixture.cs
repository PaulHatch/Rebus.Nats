...
public class RebusTestFixture : IAsyncLifetime
{
    ...
    public IBus CreateBusWithNats(string queueName, string natsConnectionString, Action<RebusNatsConfig>? natsConfig = null)
    {
        var activator = CreateActivator();
        ...
        var bus = Configure.With(activator)
            ...
            .Options(o =>
            {
                ...
                o.EnableNats(natsConnectionString, natsConfig ?? (_ => { }));
            })
            .Start();
